...
extension UIView{
    ...
    @discardableResult
    func anchor(top: NSLayoutYAxisAnchor?, bottom: NSLayoutYAxisAnchor?, leading: NSLayoutXAxisAnchor?, training: NSLayoutXAxisAnchor?, padding: UIEdgeInsets = .zero, size: CGSize = .zero) -> AnchoredConstraints{
        ...
        if let training = training{
            anchoredConstraints.trailing = trailingAnchor.constraint(equalTo: training, constant: -padding.right)
        }
        if size.width != 0 {
